...
def tweets_parser(tweet_divs: list, tweets_data: list) -> tuple:
    """
    ...
    try:
        ...
        while since_date_str != until_date_str:
            ...
            while scrolling:
                ...
                # tweet parsing
                tweets_data, tweets_scrap_dict, timestamp = tweets_parser(tweet_divs, tweets_data)
...
if __name__ == "__main__":
    ...
    since_date = datetime.strptime("2024-12-01", "%Y-%m-%d")
    until_date = datetime.strptime("2024-12-10", "%Y-%m-%d")
